...
export default function FlagError({
  ...
  useEffect(() => {
    console.error("Flag detail error:", error);
  }, [error]);

  return (
    <div className="mx-auto max-w-2xl px-4 py-24 text-center">
      <p className="text-3xl font-serif font-semibold text-slate-900">Unable to load flag</p>
      <p className="mt-3 text-slate-600">The flag data could not be retrieved. Please try again.</p>
